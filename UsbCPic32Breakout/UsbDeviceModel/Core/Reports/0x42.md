...
|----------------------|------------|------------------------------------------|------------------|-------------|--------------------|
| 01&nbsp;00&nbsp;0010 | 8 bytes    | `ss`&nbsp;`r`&nbsp;00&nbsp;`o`&nbsp;`wp` | 0000&nbsp;`iiii` | `ffffffff`  | 7 bytes            |
...
For example, pin *B0* is `01` `0000`, *C9* is `10` `1001`, etc.  Thus *A2* is `00` `0010`.  Undefined pins give invalid
