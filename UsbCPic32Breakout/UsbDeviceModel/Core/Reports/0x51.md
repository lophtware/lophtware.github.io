...
|----------------------|------------|------------------------------------------|------------------|-------------|--------------------|
| 01&nbsp;01&nbsp;0001 | 8 bytes    | `ss`&nbsp;`r`&nbsp;00&nbsp;`o`&nbsp;`wp` | 0000&nbsp;`iiii` | `ffffffff`  | 7 bytes            |
...
For example, pin *B0* is `01` `0000`, *C9* is `10` `1001`, etc.  Thus *B1* is `01` `0001`.  Undefined pins give invalid
