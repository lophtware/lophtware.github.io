...
# I<sup>2</sup>C - Half-Duplex Transfer; 520-527 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 532 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 11000001  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 527 bytes  |
...
## Payload
A block of 527 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 520 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
