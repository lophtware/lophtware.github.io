...
# I<sup>2</sup>C - Half-Duplex Transfer; 56-63 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 68 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 10000111  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 63 bytes  |
...
## Payload
A block of 63 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 56 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
