...
# I<sup>2</sup>C - Half-Duplex Transfer; 144-151 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 156 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 10010010  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 151 bytes  |
...
## Payload
A block of 151 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 144 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
