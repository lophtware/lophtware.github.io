...
# I<sup>2</sup>C - Half-Duplex Transfer; 200-207 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 212 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 10011001  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 207 bytes  |
...
## Payload
A block of 207 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 200 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
