...
# I<sup>2</sup>C - Half-Duplex Transfer; 832-839 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 844 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 11101000  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 839 bytes  |
...
## Payload
A block of 839 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 832 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
