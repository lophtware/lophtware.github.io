...
# I<sup>2</sup>C - Half-Duplex Transfer; 848-855 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 860 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 11101010  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 855 bytes  |
...
## Payload
A block of 855 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 848 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
