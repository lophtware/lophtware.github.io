...
# I<sup>2</sup>C - Half-Duplex Transfer; 1000-1007 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 1012 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 11111101  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 1007 bytes  |
...
## Payload
A block of 1007 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 1000 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
