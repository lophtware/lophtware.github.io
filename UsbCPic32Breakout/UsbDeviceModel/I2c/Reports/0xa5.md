...
# I<sup>2</sup>C - Half-Duplex Transfer; 296-303 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 308 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 10100101  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 303 bytes  |
...
## Payload
A block of 303 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 296 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
