...
# I<sup>2</sup>C - Half-Duplex Transfer; 88-95 Bytes Out, 0+ Bytes In
Report Type: Interrupt IN / OUT<br />
Report Size: 100 Bytes<br />
...
|-----------|-------------------------------------------|------------|------------|------------------|----------|
| 10001011  | `rrr`&nbsp;0&nbsp;`R`&nbsp;`c`&nbsp;`ff` | `cccccccc` | `cccccccc` | 0&nbsp;`aaaaaaa` | 95 bytes  |
...
## Payload
A block of 95 bytes that will be shifted onto the bus for an *OUT* Report, or the Slave's response for an *IN* Report.  Only the first 88 + *`rrr`* bytes are meaningful, the rest are ignored or undefined.
